package zajecia6.KodProwadzacego;

// Zadanie_1 z Zadania_tabs*.pdf - LOTTO
// Rozwiązanie zoptymalizowane Filipa
// bez kontroli zakresu dla liczb wprowadzanych przez usera (nie ma w założeniach)
